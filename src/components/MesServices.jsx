...
export default function MesServices() {
  ...
  const capabilities = [
    {
      desc: "We support shop-floor assessment and roadmap work, helping you scope execution-system improvements in phases with realistic effort and expected benefits before any commitment."
    },
    {
      desc: "We help configure work order dispatch, station-level instructions, traceability and in-process quality capture, so production records reflect what actually happened."
    },
    {
      desc: "We assist with connecting execution systems to your planning systems and to machines where signals are available, keeping orders, confirmations and inventory aligned."
    },
    {
      desc: "We prefer to prove one line through a full production cycle before wider rollout, and can support the system after go-live with agreed response times."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-[1.05] text-white max-w-xl tracking-tight">
              Execution Systems that Perform
            </h1>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-12 lg:col-span-12 space-y-5 text-center">
            ...
            <div className="space-y-4 text-slate-500 text-sm leading-relaxed max-w-3xl font-medium mx-auto text-justify">
              <p>
                A manufacturing execution system is only as good as the operator's willingness to use it. Ossisto Global supports execution-system capability that fits how your plant actually works - paperless work orders, real traceability, live production status and quality capture at the point of work.
              </p>
              <p>
                We treat this as an operations change with a software component, so we start on the floor. We map the real routing, the informal workarounds, the paperwork operators fill in twice, and the data your planners genuinely lack. That assessment usually reduces the intended scope and improves the chance of adoption.
              </p>
              <p>
                We then work in phases, proving one line or work centre across a full production cycle before expanding, and connecting to your planning systems for orders and confirmations and to machines wherever signals are available. We stay practical about how this is done: extending what you already own, or building something focused where a full system is not justified, can each be the right answer. The aim is better schedule adherence and traceability within a quarter, in a system your own team can run.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="w-full md:w-3/5 p-8 lg:p-10 flex flex-col justify-between text-left">
              <div>
                ...
                <p className="text-slate-500 text-xs leading-relaxed font-medium max-w-md text-justify">
                  Without execution-level data, plant management runs on end-of-shift summaries and experience. That is workable at low mix and becomes untenable as variants, customer-specific requirements and traceability obligations multiply. An MES closes the loop between plan and reality. It dispatches the right work order to the right station at the right revision, records what was actually produced, consumed and rejected, and enforces quality steps rather than trusting them. The operational effects are measurable - less paperwork time, fewer wrong-revision builds, faster reaction to line stoppages, and genuine genealogy for recall containment or customer audits. It is also the data foundation everything else depends on. OEE analytics, predictive maintenance, scheduling optimisation and AI-based quality models all require accurate, timestamped execution data that only this layer produces.
                </p>
              </div>
