...
export default function AppliedAiMachineLearning() {
  ...
  const capabilities = [
    {
      desc: "We define the decision a model will support, who makes it today and what accuracy would actually change their behaviour, a step that productively ends many proposed projects."
    },
    {
      desc: "We assess data sufficiency honestly before committing, covering volume, label quality, class balance and whether historical conditions still hold, through a short feasibility study on your own data."
    },
    {
      desc: "We build models for demand forecasting, yield and scrap prediction, process parameter optimisation, quality classification, pricing support and intermittent spare-parts demand."
    },
    {
      desc: "We benchmark every model against your current method and report both results side by side, including where a simpler statistical approach performs better."
    },
    {
      desc: "We engineer for production rather than demonstration, delivering inference services, retraining pipelines, drift monitoring, documented fallback behaviour and error analysis by product, plant and season."
    },
    {
      desc: "Development runs offshore with fortnightly reviews, and we place data scientists onsite in Europe and the US where proximity to process engineers improves feature quality and adoption."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-12 lg:col-span-12 space-y-5 text-center">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-black tracking-tight leading-tight max-w-2xl mx-auto">
              Forecasting, yield and process optimisation
            </h2>
            <div className="space-y-4 text-slate-500 text-sm leading-relaxed max-w-3xl font-medium mx-auto text-justify">
              <p>
                Machine learning creates real value in manufacturing when the problem is clearly defined, the right data is available, and someone is responsible for acting on the results. Ossisto Global develops practical machine learning solutions for demand forecasting, yield and scrap prediction, process parameter optimisation, quality classification, and pricing support. Every model is tested against current methods, and if a simpler statistical approach performs better, we recommend it. Our goal is not to build experimental models, but reliable solutions that improve business decisions.
              </p>
              <p>
                We begin by defining the decision the model will support, who makes it today, and what level of accuracy will create measurable business value. We then assess data quality, availability, and relevance to ensure the problem is suitable for machine learning. Development follows proven practices with proper training, validation, and testing, benchmarking every model against existing approaches and analysing performance across different scenarios instead of relying on overall accuracy alone.
              </p>
              <p>
                Production readiness is built into every solution. We implement monitoring, retraining, drift detection, and fallback mechanisms so models continue to perform reliably as business conditions change. The result is a machine learning capability that supports day-to-day operations with measurable outcomes, documented performance, and continuous monitoring—not isolated pilots or research projects, but production-ready models that deliver lasting business value.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="w-full md:w-3/5 p-8 lg:p-10 flex flex-col justify-between text-left">
              <div>
                ...
                <p className="text-slate-500 text-xs leading-relaxed font-medium max-w-md text-justify">
                  Manufacturing decisions are full of patterns too complex for spreadsheets but well within reach of modelling. Demand forecasts built on judgement carry systematic bias that inventory absorbs as cost. Scrap causes hidden in the interaction of several process parameters stay hidden under single-variable analysis. Quote pricing based on averages loses profitable work and wins unprofitable work. Applied machine learning addresses these specifically, and the returns are usually operational rather than dramatic: a few percentage points of forecast accuracy converting directly into reduced safety stock, or earlier yield-loss detection saving a shift of production. The prerequisite is honest evaluation, because models not compared against the current method, or not monitored after deployment, degrade unnoticed and erode organisational trust in analytics generally.                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="text-center space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-black tracking-tight max-w-2xl mx-auto leading-tight">
              <span className="text-[#236CB1]">Ossisto's</span>  implementation approach
            </h2>
          </div>
