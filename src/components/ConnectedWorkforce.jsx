...
export default function ConnectedWorkforce() {
  ...
  const capabilities = [
    {
      desc: "We support digital work instruction and checklist delivery on mobile devices, kept aligned to your engineering releases so guidance cannot drift out of date."
    },
    {
      desc: "We help set up skills and certification tracking, shift handover records and escalation routing, so supervisors spend less time chasing information."
    },
    {
      desc: "We assist with converting existing manuals and procedures into structured digital content, including multi-language and offline-capable formats for plant conditions."
    },
    {
      desc: "We prefer to pilot on one shift with operators involved from the start, and support adoption through floor-side training in the first months."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-12 lg:col-span-12 space-y-5 text-center">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-black tracking-tight leading-tight max-w-2xl mx-auto">
              Technology the frontline worker actually adopts - Mobile instructions, digital checklists and skills visibility            </h2>
            <div className="space-y-4 text-slate-500 text-sm leading-relaxed max-w-3xl font-medium mx-auto text-justify">
              <p>
                Automation gets the attention, but most plant improvement still runs through people - operators, technicians, supervisors and inspectors. Ossisto Global helps equip them with digital tools that take friction out of their day: work instructions on a screen, digital checklists, skills and certification records, guided fault-finding, shift handovers and quick escalation.
              </p>
              <p>
                We build from observed practice rather than a feature list. We spend time on the floor recording how work is actually communicated, where paper still wins, and what supervisors do by hand to keep a shift running. The results are deliberately narrow and useful: a checklist that replaces a clipboard, a handover record that ends the whiteboard, a skills view showing who can properly run which station today.
              </p>
              <p>
                Interfaces are kept simple, available in more than one language, and able to work when the network drops. Content is tied back to your engineering and quality records so instructions cannot drift out of date. Once frontline data capture is reliable, standard work becomes measurable and training becomes targeted. Training and floor-side support are part of how we deliver, not something left to you.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="w-full md:w-3/5 p-8 lg:p-10 flex flex-col justify-between text-left">
              <div>
                ...
                <p className="text-slate-500 text-xs leading-relaxed font-medium max-w-md text-justify">
                  Skilled labour scarcity is now the binding constraint in most manufacturing regions, and it changes what technology must do. When experienced operators retire, undocumented knowledge leaves with them; when new hires arrive, ramp-up time directly limits output. Digital work instructions and guided troubleshooting compress that ramp and reduce variation between shifts. Digital skills and certification tracking prevents the compliance exposure of unqualified operation and makes cross-training deliberate rather than accidental. Digital checklists and handovers create the audit trail that quality systems and customers increasingly demand. There is a productivity dividend as well, since supervisors typically reclaim a meaningful share of their day from chasing information, and escalations reach the right responder in minutes. The data these tools generate - real cycle times, deviation reasons, checklist exceptions - is also the most reliable improvement input a plant has.
                </p>
              </div>
