...
export default function AnalyticsBiDashboards() {
  ...
  const capabilities = [
    {
      desc: "We support assessment of your supply chain information flow, identifying visibility gaps, manual workarounds and the master data weaknesses behind them."
    },
    {
      desc: "We help set up supplier collaboration for order confirmation, delivery updates and document exchange, in forms smaller vendors can actually use."
    },
    {
      desc: "We assist with inventory accuracy, inbound visibility and exception alerts, so planners manage by deviation rather than reviewing everything."
    },
    {
      desc: "We sequence by dependency, addressing master data and inventory accuracy before planning and portals, because visibility built on poor data destroys trust."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-12 lg:col-span-12 space-y-5 text-center">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-black tracking-tight leading-tight max-w-2xl mx-auto">
              Supplier collaboration, inventory truth and planning visibility across the supply chain
            </h2>
            <div className="space-y-4 text-slate-500 text-sm leading-relaxed max-w-3xl font-medium mx-auto text-justify">
              <p>
                Most supply chain firefighting is an information problem rather than a logistics one: a supplier delay known too late, an inventory figure nobody trusts, a shortage discovered at kitting. Ossisto Global helps digitise the flows that cause this, across supplier collaboration, inbound visibility, planning, inventory accuracy and delivery tracking.
              </p>
              <p>
                We work with your existing systems rather than around them, and with your supplier base as it is today. We map how orders reach suppliers, how confirmations come back, how receipts and inspection are recorded, and where planners keep private spreadsheets because the system cannot be trusted. Those spreadsheets are the most reliable guide to where the gaps really are.
              </p>
              <p>
                Gaps are then closed in order. Master data and inventory accuracy come first, because planning built on wrong figures multiplies the error. Supplier collaboration and automatic exception alerts follow, then wider planning capability. Supplier-facing tools are kept simple enough for a small vendor with limited IT to actually use, since adoption across a mid-market supplier base fails otherwise. The aim is a planning team spending its time on decisions rather than assembling data, and problems that surface while they can still be solved.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="w-full md:w-3/5 p-8 lg:p-10 flex flex-col justify-between text-left">
              <div>
                ...
                <p className="text-slate-500 text-xs leading-relaxed font-medium max-w-md text-justify">
                  Supply chain volatility is now structural rather than exceptional, and the mid-market absorbs it with the least buffer. Poor visibility converts manageable disruptions into expedited freight, line stoppages, safety stock inflation and missed customer commitments. Digitised supplier collaboration shortens the gap between a supplier knowing about a delay and your planner knowing, often from weeks to hours, which is usually the difference between rescheduling and stopping. Accurate real-time inventory reduces both stockouts and the working capital held to hide them. Structured exception management lets a small planning team manage by deviation instead of reviewing everything. There is also a compliance dimension growing quickly, since traceability, conflict minerals, carbon reporting and EU supply-chain due-diligence requirements all demand supplier data that manual processes cannot produce reliably at scale.
                </p>
              </div>
