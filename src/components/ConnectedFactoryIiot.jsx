...
export default function ConnectedFactoryIiot() {
  ...
  const capabilities = [
    {
      desc: "We support connectivity surveys across your machine base, identifying what can be read from existing controls and what needs additional sensing."
    },
    {
      desc: "We help deploy edge devices and protocol conversion so older equipment can share data without changes to validated control logic."
    },
    {
      desc: "We assist with organising machine data into a consistent asset and tag structure, and with the network separation that keeps plant systems protected."
    },
    {
      desc: "We prefer to start with a few representative machines and one clear use case, measuring before and after rather than demonstrating."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-[1.05] text-white max-w-xl tracking-tight">
              Intelligence through Connectivity
            </h1>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-12 lg:col-span-12 space-y-5 text-center">
            <span className="text-ossisto-blue text-xs font-black uppercase tracking-wider block">
              THE VITAL DIGITAL BRIDGE
            </span>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-black tracking-tight leading-tight max-w-3xl mx-auto">
              Make Your Machines Talk
            </h2>
            <p className="text-sm sm:text-base font-bold text-slate-800 max-w-3xl mx-auto">
              Retrofit, connect and contextualise - IIoT architecture for factories that were not built for it
            </p>
            <div className="space-y-4 text-slate-500 text-sm leading-relaxed max-w-3xl font-medium mx-auto text-justify pt-2">
              <p>
                Most factories already generate more data than they use. It sits inside machine controls, drives and standalone equipment, where nobody can reach it. Ossisto Global helps connect that estate, including older machines with no networking of their own, and get the data somewhere useful.
              </p>
              <p>
                We start from a use case and work backwards to the data needed. We survey the machine base - what each control can share, what is already collected, and how the network is arranged - and produce a plan that separates machines worth full instrumentation from those needing only a signal or two. Older equipment is fitted with simple add-on sensing, without touching control logic that has already been validated.
              </p>
              <p>
                Data is then organised into a consistent structure, so a reading means the same thing on every line and in every plant. This is the step most projects skip and later regret. We also keep plant and office networks properly separated, with no uncontrolled route out of the factory. The value compounds, because a well-organised data layer makes every later analytics, maintenance or quality initiative cheaper to deliver.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="w-full md:w-3/5 p-8 lg:p-10 flex flex-col justify-between text-left">
              <div>
                ...
                <p className="text-slate-500 text-xs leading-relaxed font-medium max-w-md text-justify">
                  You cannot improve what you cannot see, and most plants cannot see at machine level in real time. Manual data collection is late, partial and expensive; without it, decisions about capacity, bottlenecks, downtime causes and energy use are made on anecdote. Connecting the asset base changes the operating rhythm. Deviations surface in minutes rather than at month end, downtime causes become quantified rather than debated, and energy and consumable use become manageable line items. There is a strategic dimension too, as customer audits and sustainability reporting increasingly require verifiable operational data. Every advanced capability - OEE benchmarking, predictive maintenance, closed-loop quality, AI-driven scheduling - is gated by whether clean, contextualised machine data exists. Building that layer once, properly, avoids paying for it repeatedly through disconnected point solutions.
                </p>
              </div>
