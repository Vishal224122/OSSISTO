...
export default function EngineeringDocumentationDrafting() {
  const [activeTab, setActiveTab] = useState('intro');
  const [isScrolled, setIsScrolled] = useState(false);

  const capabilities = [
    {
      desc: "We support drafting and technical writing, working to your templates, standards and terminology so output is consistent with what you already publish."
    },
    {
      desc: "We help produce work instructions, service and installation documentation, troubleshooting guides and illustrated spare-parts listings."
    },
    {
      desc: "We assist with digitising and reorganising legacy documentation, including drawing conversion, revision reconciliation and tagging so records become searchable."
    },
    {
      desc: "We can start with a defined sample, agree a template and style baseline, then move to a steady weekly output with a checking step before release."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            <span className="text-ossisto-blue text-xs md:text-sm font-extrabold uppercase tracking-widest block">
              ENGINEERING DOCUMENTATION & DRAFTING SUPPORT
            </span>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-12 lg:col-span-12 space-y-5 text-center">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-black tracking-tight leading-tight max-w-2xl mx-auto">
              Drawings, manuals and technical content
            </h2>
            <div className="space-y-4 text-slate-500 text-sm leading-relaxed max-w-3xl font-medium mx-auto text-justify">
              <p>
                Documentation is the deliverable your customers, service technicians and auditors judge you by, and the one most often produced under time pressure by engineers who would rather be designing. Ossisto Global provides dedicated drafting and technical writing teams that work to your templates, standards and terminology.
              </p>
              <p>
                Our approach fixes the system rather than the individual document. We establish templates, style guides, terminology lists, illustration standards and file naming, so output stays consistent regardless of who produces it. Where it helps, we move clients from large single documents to modular content that can be assembled per variant and per market, which is what makes multi-language documentation affordable.
              </p>
              <p>
                Our teams then handle steady production of drawing packs, work instructions, service literature and compliance documentation, with a checking step before release. We also digitise the archive, so legacy paper and scanned drawings become searchable, versioned records that keep pace with the product.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="w-full md:w-3/5 p-8 lg:p-10 flex flex-col justify-between text-left">
              <div>
                ...
                <p className="text-slate-500 text-xs leading-relaxed font-medium max-w-md text-justify">
                  Documentation quality has direct operational consequences. Ambiguous work instructions cause assembly errors and scrap. Outdated service manuals extend mean time to repair and generate avoidable support calls. Incomplete technical files delay CE marking or customer approvals. Inconsistent drawings cause supplier quoting errors and incorrect first articles. For manufacturers selling into regulated or export markets, documentation is also a legal deliverable, since machinery directive files, conformity declarations and language requirements are not optional. Investing in structured documentation reduces all of these costs at once, and produces a further benefit that is easy to miss: clean, structured technical content is the raw material for digital service portals, spare-parts e-commerce, AR-assisted maintenance and AI-based support assistants. Poorly structured content blocks every one of them.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-5 space-y-4 text-left relative">
            <h2 className="text-2xl sm:text-3xl font-black text-black tracking-tight leading-tight max-w-sm relative z-10 pt-4">
              Our key areas for Engineering documentation & drafting support
            </h2>
          </div>
