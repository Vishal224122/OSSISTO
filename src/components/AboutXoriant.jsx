...
export default function AboutXoriant() {
  ...
  const stats = [
    {
      ...
      icon: "https://www.xoriant.com/sites/default/files/styles/webp/public/2023-04/Client-Value-Co-Creation.png.webp?itok=1"
    },
    {
      value: `${counters.employees}+`,
      label: "Global Engineers",
      desc: "Skilled in advanced AI, Cloud and SaaS.",
      icon: "https://www.xoriant.com/sites/default/files/styles/webp/public/2023-04/Global-Talent-Pool.png.webp?itok=2"
    },
    {
      value: `${counters.offices}+`,
      label: "Delivery Centers",
      desc: "Providing 24/7 engineering redundancy.",
      icon: "https://www.xoriant.com/sites/default/files/styles/webp/public/2023-04/Global-Presence.png.webp?itok=3"
    },
    {
      value: `${counters.products}+`,
      label: "Products Engineered",
      desc: "Deployed at scale globally.",
      icon: "https://www.xoriant.com/sites/default/files/styles/webp/public/2023-04/IP-Co-Creation.png.webp?itok=4"
    }
  ];

  return (
    <section id="about-xoriant" className="bg-[#0b0f19] py-20 px-4 sm:px-6 lg:px-8 border-b border-slate-900 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-8 space-y-8">
          <div className="space-y-4">
            <span className="text-xoriant-green text-xs font-bold uppercase tracking-widest block">About Xoriant</span>
            ...
            <p className="text-slate-400 text-sm md:text-base leading-relaxed">
              For over three decades, Xoriant has partnered with enterprise technology leaders to architect, build, and scale digital products. We offer end-to-end capabilities across Cloud Application Modernization, Advanced AI, Cybersecurity, and Quality Engineering.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 pt-4">
            {stats.map((stat, index) => (
              <div 
                key={index}
                className="bg-slate-950 border border-slate-900 hover:border-xoriant-green/45 p-5 rounded-2xl transition-all duration-300 group shadow-md"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="block text-2xl md:text-3xl font-black text-white group-hover:text-xoriant-green transition-colors">
                      {stat.value}
                    </span>
        ...
        <div className="lg:col-span-4 relative">
          <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl border border-slate-800 group/video bg-slate-900">
            ...
            <img 
              src="https://www.xoriant.com/cdn/ff/caTR1zNKWw-48WXXuCHM7xARmfsJvEbyLdj-0ccie_8/1771476514/public/styles/webp/public/2026-02/Xoriant-Document-Automation-Platform-Development-for-Mortgage-ISV.jpg.webp?itok=G_aoqKyR" 
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-950/45 group-hover/video:bg-slate-950/60 transition-colors p-4">
              <button 
                ...
                className="text-white hover:text-xoriant-green transition-all transform hover:scale-110 active:scale-95 duration-300"
                aria-label="Play sleep number video case study"
              >
                <PlayCircle className="w-12 h-12 stroke-[1.25]" />
              </button>
              <div className="text-center mt-2 space-y-1">
                <span className="block text-[10px] text-xoriant-green font-bold uppercase tracking-widest">Case Study Video</span>
      ...
      {isVideoOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div className="relative w-full max-w-4xl bg-xoriant-dark border border-slate-800 rounded-2xl overflow-hidden aspect-video shadow-2xl z-10 animate-fade-in">
            {/* Close Button */}
            <button 
              onClick={() => setIsVideoOpen(false)}
              className="absolute top-4 right-4 text-white hover:text-xoriant-green z-20 p-2 bg-slate-900/60 rounded-full border border-slate-850 hover:border-xoriant-green transition-all"
